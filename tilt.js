...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // -------------------------------------------------------------------------------------
    // 4. GELİŞMİŞ EFEKT: MOUSE TAKİPLİ 3D TILT (Mouse Listener'ı Z-0 linkine taşıdık)
    // -------------------------------------------------------------------------------------
    ...
    setTimeout(() => {
        ...
        document.querySelectorAll('#kartlar .w-full').forEach(card => {
            ...
            // Mouse kartın üzerine girdiğinde olay dinleyicisini Z-0 linkine tanımla
            interactiveElement.addEventListener('mousemove', (e) => {
                
                // Tilt'i uyguladığımız kart (parent) elementini hedefle
                ...
                // Eksen döndürme açılarını hesapla (Max 6 derece)
            ...
            // Mouse karttan ayrıldığında eski haline döndür (mouseleave olayı hala card'da dinlenmeli)
